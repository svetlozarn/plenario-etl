...
outPathDup = "/home/alund/wopr/processed_data/dup/"
outPathDedup = "/home/alund/wopr/processed_data/dedup/"
...
if args.dedup==True:
    ...
    dfDup.to_csv(outPathDup + outFileDup, index=False)
    dfDedup.to_csv(outPathDedup + outFileDedup, index=False)
...
if args.length==True:
    ...
    for c in args.cols:
        ...
        print "Longest: " + max(map(lambda x: str(x), df[c]), key=len)
