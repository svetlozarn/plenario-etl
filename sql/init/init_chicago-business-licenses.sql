...
PAYMENT_DATE DATE,
CONDITIONAL_APPROVAL VARCHAR(100),
...
\copy SRC_chicago_business_licenses FROM '/project/evtimov/wopr/data/chicago-business-licenses_2014-03-23.csv' WITH (FORMAT CSV, HEADER true, DELIMITER ',');
